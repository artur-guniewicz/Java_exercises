...
public class SearchContact extends JDialog {
    ...
    public SearchContact(JFrame parent, Dictionary dictionary) {
        super(parent, true);
        ...
        if (dictionary.isEmpty()) {
            textField.setText("Brak wpisów w książce telefonicznej");
        } else {
